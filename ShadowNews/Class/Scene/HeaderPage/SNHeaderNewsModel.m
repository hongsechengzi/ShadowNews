...
@implementation SNHeaderNewsModel
- (void)dealloc
{
    self.title = nil;
    self.imgSrc = nil;
...
{
    SNHeaderNewsModel * model = [[[self class] alloc] initWithImgSrc:imgSrc title:title replyCount:replyCount docId:docId digest:digest tag:tag imgExtraArray:imgExtraArray];
